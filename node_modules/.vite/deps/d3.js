...
function linePoint(lambda, phi2) {
  ...
  if (p0) {
    ...
    var delta = lambda - lambda2, sign3 = delta > 0 ? 1 : -1, lambdai = inflection[0] * degrees2 * sign3, phii, antimeridian = abs3(delta) > 180;
...
function centroid_default(object2) {
  ...
  return [atan2(y4, x4) * degrees2, asin(z / m3) * degrees2];
}
...
function polygonContains_default(polygon, point6) {
  ...
  return (angle2 < -epsilon6 || angle2 < epsilon6 && sum5 < -epsilon22) ^ winding & 1;
}
...
function interpolate_default2(a4, b) {
  ...
  var interpolate = d ? function(t) {
    ...
    return [
      atan2(y4, x4) * degrees2,
      atan2(z, sqrt(x4 * x4 + y4 * y4)) * degrees2
    ];
  } : function() {
...
function projectionMutator(projectAt) {
  ...
  projection2.clipAngle = function(_) {
    return arguments.length ? (preclip = +_ ? circle_default2(theta = _ * radians2) : (theta = null, antimeridian_default), reset()) : theta * degrees2;
  };
  ...
  projection2.center = function(_) {
    return arguments.length ? (lambda = _[0] % 360 * radians2, phi2 = _[1] % 360 * radians2, recenter()) : [lambda * degrees2, phi2 * degrees2];
  };
  projection2.rotate = function(_) {
    return arguments.length ? (deltaLambda = _[0] % 360 * radians2, deltaPhi = _[1] % 360 * radians2, deltaGamma = _.length > 2 ? _[2] % 360 * radians2 : 0, recenter()) : [deltaLambda * degrees2, deltaPhi * degrees2, deltaGamma * degrees2];
  };
  projection2.angle = function(_) {
    return arguments.length ? (alpha = _ % 360 * radians2, recenter()) : alpha * degrees2;
  };
...
function conicProjection(projectAt) {
  ...
  p.parallels = function(_) {
    return arguments.length ? m3(phi02 = _[0] * radians2, phi12 = _[1] * radians2) : [phi02 * degrees2, phi12 * degrees2];
  };
  return p;
}
...
function identity_default4() {
  ...
  projection2.angle = function(_) {
    return arguments.length ? (alpha = _ % 360 * radians2, sa = sin2(alpha), ca3 = cos2(alpha), reset()) : alpha * degrees2;
  };
  projection2.reflectX = function(_) {
...
function partition_default() {
  ...
  function partition(root5) {
    ...
    if (round)
      root5.eachBefore(round_default);
    return root5;
  }
...
function hue(a4, b) {
  var d = b - a4;
  return d ? linear2(a4, d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d) : constant_default10(isNaN(a4) ? b : a4);
}
function gamma(y4) {
  return (y4 = +y4) === 1 ? nogamma : function(a4, b) {
    return b - a4 ? exponential(a4, b, y4) : constant_default10(isNaN(a4) ? b : a4);
  };
}
function nogamma(a4, b) {
  var d = b - a4;
  return d ? linear2(a4, d) : constant_default10(isNaN(a4) ? b : a4);
}

// node_modules/d3/node_modules/d3-interpolate/src/rgb.js
var rgb_default2 = function rgbGamma(y4) {
  var color3 = gamma(y4);
...
var rgbBasis2 = rgbSpline(basis_default);
...
function string_default2(a4, b) {
  ...
  return s2.length < 2 ? q[0] ? one(q[0].x) : zero3(b) : (b = q.length, function(t) {
...
function value_default2(a4, b) {
  var t = typeof b, c6;
  return b == null || t === "boolean" ? constant_default10(b) : (t === "number" ? number_default2 : t === "string" ? (c6 = color2(b)) ? (b = c6, rgb_default2) : string_default2 : b instanceof color2 ? rgb_default2 : b instanceof Date ? date_default : isNumberArray(b) ? numberArray_default : Array.isArray(b) ? genericArray : typeof b.valueOf !== "function" && typeof b.toString !== "function" || isNaN(b) ? object_default : number_default2)(a4, b);
}
...
var interpolateTransformCss2 = interpolateTransform(parseCss, "px, ", "px)", "deg)");
var interpolateTransformSvg2 = interpolateTransform(parseSvg, ", ", ")", ")");
...
function cubehelix3(hue2) {
  return function cubehelixGamma(y4) {
    ...
    function cubehelix4(start2, end) {
      var h = hue2((start2 = cubehelix2(start2)).h, (end = cubehelix2(end)).h), s2 = nogamma(start2.s, end.s), l = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
      return function(t) {
        start2.h = h(t);
        start2.s = s2(t);
...
var cubehelixLong2 = cubehelix3(nogamma);
...
var Path3 = class {
  ...
  arc(x4, y4, r, a0, a1, ccw) {
    ...
    } else if (Math.abs(this._x1 - x06) > epsilon7 || Math.abs(this._y1 - y06) > epsilon7) {
...
function transformer2() {
  var domain = unit, range5 = unit, interpolate = value_default2, transform2, untransform, unknown, clamp = identity4, piecewise2, output, input;
  function rescale() {
  ...
  scale2.invert = function(y4) {
    return clamp(untransform((input || (input = piecewise2(range5, domain.map(transform2), number_default2)))(y4)));
  };
  scale2.domain = function(_) {
  ...
  scale2.rangeRound = function(_) {
    return range5 = Array.from(_), interpolate = round_default2, rescale();
  };
...
function nice3(domain, interval2) {
  domain = domain.slice();
...
function calendar(ticks3, tickInterval, year, month, week, day, hour, minute, second2, format2) {
  ...
  scale2.nice = function(interval2) {
    ...
    return interval2 ? domain(nice3(d, interval2)) : scale2;
  };
  scale2.copy = function() {
...
function transformer3() {
  ...
  scale2.range = range5(value_default2);
  scale2.rangeRound = range5(round_default2);
  scale2.unknown = function(_) {
    return arguments.length ? (unknown = _, scale2) : unknown;
  };
  return function(t) {
...
function data_default4(value, key) {
  ...
  if (typeof value !== "function")
    value = constant_default11(value);
  for (var m3 = groups3.length, update = new Array(m3), enter = new Array(m3), exit = new Array(m3), j = 0; j < m3; ++j) {
...
function arc_default() {
  var innerRadius = arcInnerRadius, outerRadius = arcOuterRadius, cornerRadius = constant_default12(0), padRadius = null, startAngle = arcStartAngle, endAngle = arcEndAngle, padAngle = arcPadAngle, context = null, path3 = withPath(arc);
  function arc() {
    ...
    if (!(r1 > epsilon8))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon8 && (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)), rc = min4(abs4(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t03, t13;
      if (rp > epsilon8) {
...
function line_default2(x4, y4) {
  var defined = constant_default12(true), context = null, curve = linear_default, output = null, path3 = withPath(line);
  x4 = typeof x4 === "function" ? x4 : x4 === void 0 ? x3 : constant_default12(x4);
  y4 = typeof y4 === "function" ? y4 : y4 === void 0 ? y3 : constant_default12(y4);
  function line(data) {
  ...
  line.x = function(_) {
    return arguments.length ? (x4 = typeof _ === "function" ? _ : constant_default12(+_), line) : x4;
  };
  line.y = function(_) {
    return arguments.length ? (y4 = typeof _ === "function" ? _ : constant_default12(+_), line) : y4;
  };
...
function area_default5(x06, y06, y12) {
  var x12 = null, defined = constant_default12(true), context = null, curve = linear_default, output = null, path3 = withPath(area);
  x06 = typeof x06 === "function" ? x06 : x06 === void 0 ? x3 : constant_default12(+x06);
  y06 = typeof y06 === "function" ? y06 : y06 === void 0 ? constant_default12(0) : constant_default12(+y06);
  y12 = typeof y12 === "function" ? y12 : y12 === void 0 ? y3 : constant_default12(+y12);
  function area(data) {
...
function pie_default() {
  var value = identity_default5, sortValues = descending_default, sort3 = null, startAngle = constant_default12(0), endAngle = constant_default12(tau7), padAngle = constant_default12(0);
  function pie(data) {
    var i, n = (data = array_default3(data)).length, j, k2, sum5 = 0, index4 = new Array(n), arcs = new Array(n), a0 = +startAngle.apply(this, arguments), da2 = Math.min(tau7, Math.max(-tau7, endAngle.apply(this, arguments) - a0)), a1, p = Math.min(Math.abs(da2) / n, padAngle.apply(this, arguments)), pa = p * (da2 < 0 ? -1 : 1), v2;
    for (i = 0; i < n; ++i) {
...
function link2(curve) {
  ...
  link3.x = function(_) {
    return arguments.length ? (x4 = typeof _ === "function" ? _ : constant_default12(+_), link3) : x4;
  };
  link3.y = function(_) {
    return arguments.length ? (y4 = typeof _ === "function" ? _ : constant_default12(+_), link3) : y4;
  };
...
function Symbol2(type2, size) {
  ...
  type2 = typeof type2 === "function" ? type2 : constant_default12(type2 || circle_default3);
  size = typeof size === "function" ? size : constant_default12(size === void 0 ? 64 : +size);
  function symbol() {
    let buffer;
    if (!context)
      context = buffer = path3();
...
function stack_default() {
  ...
  stack.keys = function(_) {
    return arguments.length ? (keys = typeof _ === "function" ? _ : constant_default12(Array.from(_)), stack) : keys;
  };
  stack.value = function(_) {
    return arguments.length ? (value = typeof _ === "function" ? _ : constant_default12(+_), stack) : value;
  };
  stack.order = function(_) {
    return arguments.length ? (order = _ == null ? none_default2 : typeof _ === "function" ? _ : constant_default12(Array.from(_)), stack) : order;
  };
...
function zoom_default3() {
  ...
  zoom.filter = function(_) {
    return arguments.length ? (filter6 = typeof _ === "function" ? _ : constant_default13(!!_), zoom) : filter6;
  };
  zoom.touchable = function(_) {
    return arguments.length ? (touchable = typeof _ === "function" ? _ : constant_default13(!!_), zoom) : touchable;
  };
  zoom.extent = function(_) {
    return arguments.length ? (extent3 = typeof _ === "function" ? _ : constant_default13([[+_[0][0], +_[0][1]], [+_[1][0], +_[1][1]]]), zoom) : extent3;
  };
...
export {
  ...
  round_default2 as interpolateRound,
